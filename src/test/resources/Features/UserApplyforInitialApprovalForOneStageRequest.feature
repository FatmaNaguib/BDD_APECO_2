Feature:  User Applay For New Initial Approval One Stage Request Successfully

@UserLogin 
Scenario: Check Thet  User Can Applay For New Initial Approval with One stage Request Successfully
