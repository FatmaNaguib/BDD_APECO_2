Feature:  User Applay For New Initial Approval Request Successfully

@UserLogin  @ThreeStagesInitialApprovalRequest
Scenario: Check Thet  User Can Applay For New Initial Approval For Three Stages Request Successfully
	...
	@UserLogin 
Scenario: Check Thet  User Can Applay For New Initial Approval For Two Stages Request Successfully
